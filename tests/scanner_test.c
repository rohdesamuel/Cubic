...
extern void scanner_all_tests() {
  ...
  TEST_TOKEN_STREAM("let x : int = 1234",
    TK_LET, TK_ID, TK_COLON, TK_INT, TK_EQUAL, TK_INTEGER, TK_EOF);

  TEST_TOKEN_STREAM("let x := function (x) -> int x",
    TK_LET, TK_ID, TK_COLON, TK_EQUAL,
