...
#define DEBUG_INSTRUCTION(OP, DEBUG_INSTR) case OP: return DEBUG_INSTR(#OP, chunk, offset)
  ...
  switch (instruction) {
    ...
    DEBUG_INSTRUCTION(OP_ADD_OFFSET, byte_instruction);
    DEBUG_INSTRUCTION(OP_GET_OFFSET, byte_instruction);
    DEBUG_INSTRUCTION(OP_SET_OFFSET, byte_instruction);
    ...
    DEBUG_INSTRUCTION(OP_REF_MAKE, simple_instruction);
    DEBUG_INSTRUCTION(OP_GET_REF, byte_instruction);
    DEBUG_INSTRUCTION(OP_SET_REF, byte_instruction);
    DEBUG_INSTRUCTION(OP_ADDROF_VAR, byte_instruction);
    DEBUG_INSTRUCTION(OP_ADDROF_REF, byte_instruction);
